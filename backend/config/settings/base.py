...
SECRET_KEY = os.getenv('SECRET_KEY', 'default-unsecure-secret-key-change-in-env')
...
SPECTACULAR_SETTINGS = {
    ...
    'ENUM_NAME_OVERRIDES': {
        'OrganizationMembershipRoleEnum': 'apps.organizations.models.OrganizationMembership.Role',
        'WeeklyScheduleDayOfWeekEnum': 'apps.providers.models.WeeklySchedule.DayOfWeek',
